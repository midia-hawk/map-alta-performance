    ...
    <Section className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center space-y-4 sm:space-y-6 mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-primary px-4 sm:px-6 py-2 rounded-full text-map-dark font-semibold text-sm sm:text-base">
        ...
        <div className="bg-secondary border border-border rounded-2xl p-6 sm:p-8 lg:p-12">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 justify-center lg:justify-start">
                  <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-map-cyan flex-shrink-0 mt-1" />
                  <p className="text-base sm:text-lg text-left">Evento 100% presencial, prático e intensivo</p>
                </div>
                <div className="flex items-start gap-3 justify-center lg:justify-start">
                  <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-map-cyan flex-shrink-0 mt-1" />
                  <p className="text-base sm:text-lg text-left">Duração de 2 dias completos de imersão</p>
                </div>
                <div className="flex items-start gap-3 justify-center lg:justify-start">
                  <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-map-cyan flex-shrink-0 mt-1" />
                  <p className="text-base sm:text-lg text-left">Métodos aplicáveis imediatamente no seu negócio</p>
                </div>
                <div className="flex items-start gap-3 justify-center lg:justify-start">
                  <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-map-cyan flex-shrink-0 mt-1" />
                  <p className="text-base sm:text-lg text-left">Turma exclusiva e limitada</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-primary p-6 sm:p-8 rounded-xl">
              <div className="text-map-dark text-center">
                <h4 className="text-xl sm:text-2xl font-bold mb-4">Diferente de cursos teóricos</h4>
