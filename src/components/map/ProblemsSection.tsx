    ...
    <Section variant="dark" className="relative">
      <div className="container mx-auto px-4">
              ...
              <div className="bg-card border border-border rounded-xl p-6 h-full transition-smooth hover:border-map-cyan/50 hover:shadow-glow/20">
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-3">
                    <h3 className="font-semibold text-lg group-hover:text-map-cyan transition-smooth">
                      {problem.title}
                    </h3>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-primary p-8 rounded-2xl max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-map-dark mb-4">
              É hora de transformar sua realidade empresarial!
            </h3>
            <p className="text-lg text-map-dark/80">
